            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text('Welcome Back!' , style: TextStyle(color: Colors.black , fontWeight: FontWeight.bold , fontSize: 24),),
                ),
                Container(
                  margin: EdgeInsets.only(top: ScreenUtils.getDesignHeight(5)),
                  child: Text('Please login to place your bids and gain access to other features' , style: TextStyle(color: Colors.black.withOpacity(0.6) , fontSize: 18),),
                ),
                Container(
                  margin: EdgeInsets.only(top: ScreenUtils.getDesignHeight(30)),
